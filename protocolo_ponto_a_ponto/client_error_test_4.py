...
def main():
    try:
        ...
        while inicia:
            ...
            tipo = 1 # (ERRO) forçando erro no tipo de mensagem na checagem
            while cont <= total_pacotes:
                ...
                # (ERRO) iniciando o timer do erro e 20 segundos
                timer_erro = time.time()
                while not pacote_recebido:
                    # (ERRO) Quando passar 20 segundos, a checagem normal volta
